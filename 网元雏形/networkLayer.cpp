...
int main() {
    ...
    networkCatchPhyAddr.sin_addr.S_un.S_addr = inet_addr("127.0.0.1");
    ...
    fd_set rfd;
    int netCatchAppLen = sizeof(networkCatchAppAddr);
    int netCatchPhyLen = sizeof(networkCatchPhyAddr);
    ...
    while(1)
    {
        ...
        {
            char appStr[100] = {0};
            int recvApp = recvfrom(networkCatchAppSock,appStr,100,0,(SOCKADDR*)&networkCatchAppAddr,&netCatchAppLen);
        ...
        {
            char phyStr[100] = {0};
            int recvPhy = recvfrom(networkCatchPhySock,phyStr,100,0,(SOCKADDR*)&networkCatchPhyAddr,&netCatchPhyLen);
